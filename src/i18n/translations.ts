...
const uk = {
  ...
  story: { title: 'Від цього дня — назавжди.', copy: '16 вересня ми скажемо одне одному «так». Цей день стане початком нашого нового розділу, і для нас особливо важливо розділити його з тими, хто дорогий нашим серцям.', sign: 'З любовʼю,' },
...
const en: typeof uk = {
  ...
  story: { title: 'From this day forward.', copy: 'On September 16, we’ll say “yes” to each other. This day will begin a new chapter for us, and it means the world to share it with the people closest to our hearts.', sign: 'With love,' },
...
const ru: typeof uk = {
  ...
  story: { title: 'С этого дня — навсегда.', copy: '16 сентября мы скажем друг другу «да». Этот день станет началом нашей новой главы, и для нас особенно важно разделить его с теми, кто дорог нашим сердцам.', sign: 'С любовью,' },
