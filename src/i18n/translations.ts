...
const uk = {
  ...
  story: { eyebrow: 'НАША ІСТОРІЯ', title: 'Найкращі речі не можна загорнути.', copy: 'Нам пощастило знайти одне одного. Тепер ми хочемо розділити цей день з людьми, які зробили нашу історію особливою.', sign: 'З любовʼю,' },
...
const en: typeof uk = {
  ...
  story: { eyebrow: 'OUR STORY', title: 'The best things can’t be wrapped.', copy: 'We were lucky enough to find each other. Now we want to share this day with the people who made our story special.', sign: 'With love,' },
...
const ru: typeof uk = {
  ...
  story: { eyebrow: 'НАША ИСТОРИЯ', title: 'Лучшие вещи нельзя завернуть.', copy: 'Нам повезло найти друг друга. Теперь мы хотим разделить этот день с людьми, которые сделали нашу историю особенной.', sign: 'С любовью,' },
